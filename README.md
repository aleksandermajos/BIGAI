...
| NAME                                                            | TIME      |
|-----------------------------------------------------------------|-----------|
| FLET CODER WITH SANDBOX                                         | 30        |
| TASK FROM A                                                     | 24        |
| TASK FROM B                                                     | 24        |
| VISIALIZE TASK AS GRAPH                                         | 30        |
| CREWAI TO SERVER                                                | 16        |
...
| RAG FULL                                                        | 30        |
| DART TS TO SERVER                                               | 8         |
| FOUNDATION MODELS TO SERVER                                     | 8         |
| CREATE UNIFIED API FOR ALL REQUESTS                             | 24        |
| ONE BROKER OND INSTRUMENT                                       | 16        |
| ONE BROKER MANY INSTRUMENTS                                     | 16        |
| MANY BROKER ONE INSTRUMENT                                      | 16        |
| MANY BROKER MANY INSTRUMENTS                                    | 16        |
| TESTER FULL                                                     | 24        |
| WELCOMING WINDOW                                                | 12        |
| LANGUAGE ELEMENT                                                | 12        |
| WEB VERSION+USER DB SERVER                                      | 24        |
