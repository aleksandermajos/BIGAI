...
|-------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|
| BIGAI_ENGINE_INTRO                                                | N/A                                                                                                            | N/A                                                                                                                                                                                                                   | [BIGAI_ENGINE_INTRO](https://youtu.be/Low9650NRI4) |
| FASTAPI CLIENT/SERVER LOCALLY                                     | N/A                                                                                                            | [FASTAPI SERVER LOCALLY](https://github.com/aleksandermajos/BIGAI/blob/main/ENGINE/API_BIGAI_SERVER.py) <br/> [FASTAPI CLIENT LOCALLY](https://github.com/aleksandermajos/BIGAI/blob/main/ENGINE/API_BIGAI_CLIENT.py) | 🔥                                                 |
| VOICE ACTIVITY DETECTION - VAD LOCALLY                            | [VAD LOCALLY](https://github.com/aleksandermajos/BIGAI/blob/main/ENGINE/VAD_SCELETON_WITH_TTS_STT_GROQ.py)     | N/A                                                                                                                                                                                                                   | 🔥                                                 |
| TEXT GEN GROQ EXTERNALLY                                          | [GROQ EXTERNALLY](https://github.com/aleksandermajos/BIGAI/blob/main/ENGINE/VAD_SCELETON_WITH_TTS_STT_GROQ.py) | N/A                                                                                                                                                                                                                   | 🔥                                                 |
| CODE GEN CODESTRAL LOCALLY                                        | 🔥                                                                                                             | 🔥                                                                                                                                                                                                                    |                                                    |
| STT WHISPERX LOCALLY                                              | N/A                                                                                                            | [STT WHISPERX LOCALLY](https://github.com/aleksandermajos/BIGAI/blob/main/ENGINE/API_BIGAI_SERVER.py)                                                                                                                 | 🔥                                                 |
| TRANSLATE NLLB LOCALLY                                            | N/A                                                                                                            | [TRANSLATE NLLB LOCALLY](https://github.com/aleksandermajos/BIGAI/blob/main/ENGINE/API_BIGAI_SERVER.py)                                                                                                               | 🔥                                                 |
| TTS OPENAI EXTERNALLY                                             | [TTS OPENAI EXTERNALLY](https://github.com/aleksandermajos/BIGAI/blob/main/ENGINE/KEY_OPENAI.py)               | N/A                                                                                                                                                                                                                   | 🔥                                                 |
| TTS OPENVOICE AND MELOTTS LOCALLY                                 | 🔥                                                                                                             | 🔥                                                                                                                                                                                                                    |                                                    |
| GEN PIC SD3 LOCALLY                                               |                                                                                                                |                                                                                                                                                                                                                       |                                                    |
| RECO PIC PHI3 VISION LOCALLY                                      | [PIC_REGOG_PHI3VISION](https://github.com/aleksandermajos/BIGAI/blob/main/ENGINE/PIC_REGOG_PHI3VISION.py)      |                                                                                                                                                                                                                       |                                                    |
| RECO PIC CLOUDE EXTERNALLY                                        |                                                                                                                |                                                                                                                                                                                                                       |                                                    |
| OCR KANJI LOCALLY                                                 | [OCR_JAPANESE_MANGAOCR](https://github.com/aleksandermajos/BIGAI/blob/main/ENGINE/OCR_JAPANESE_MANGAOCR.py)    | 🔥                                                                                                                                                                                                                    |                                                    |
