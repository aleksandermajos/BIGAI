import numpy as np
import pandas as pd
from BUSINESS.QUANT.DATA_OHLC_MANIPULATE import MT4_DF_to_CLASSIFICATION
from BUSINESS.QUANT.DATA_OHLC_MANIPULATE import MT5_DF_to_CLASSIFICATION
from BUSINESS.QUANT.DATA_OHLC_MANIPULATE import cTRADER_DF_to_CLASSIFICATION
