...
def tts_openai(text: str, voice: str, output: str):
    url = "http://127.0.0.1:8000/tts_openai"
    payload = {
        "text": text,
        "voice": voice,
        "output_path": output
...
if __name__ == "__main__":
    tts_openai(text='Stimmt. Aber wir könnten uns ja ein nettes kleines Airbnb suchen, vielleicht ein bisschen außerhalb vom direkten Zentrum, um Kosten zu sparen. Hauptsache, wir erleben die Stadt',voice="alloy",output='out_openai.mp3')
    oko=4
