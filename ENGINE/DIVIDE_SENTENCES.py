import pandas as pd
Sentences = pd.read_excel('SENTENCES_DE_1000_V1_RAW.xlsx')
...
df_sentence.to_excel("SENTENCES_DE_1000_V1.xlsx", index=False)
df_translation = pd.DataFrame(translation,columns =['TRANSLATION'])
df_translation.to_excel("SENTENCES_DE_EN_1000_V1.xlsx", index=False)
'''
