...
from ENGINE.ALL.QM_OANDA_DATA import OandaData
from ENGINE.ALL.QM_OHLC_MANIPULATE import OHLC_DF_to_CLASSIFICATION_C, OHLC_DF_to_REGRESSION_C
from ENGINE.ALL.QM_DF_TO_PYTORCH_FORECASTING import DF_to_TSDataSet
...
OD = OandaData()
data = OD.GetData("2021-10-11T00:00:00Z", "2021-11-11T00:00:00Z", "EUR_USD", "H4", "DF")
